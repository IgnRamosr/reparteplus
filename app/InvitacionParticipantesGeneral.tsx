...
// 👉 Nuevo: abrir pantalla que genera y muestra el QR multi-uso (24h)
...
}, [participanteId, grupoId, nombreGrupo, tieneGrupoValido]);
...
return (
    ...
    {/* Botón primario: compartir enlace */}
    <Pressable
    ...
    {/* Mostrar QR del grupo (habilitado) */}
    <Pressable
        onPress={abrirQR}
        disabled={!tieneGrupoValido}
